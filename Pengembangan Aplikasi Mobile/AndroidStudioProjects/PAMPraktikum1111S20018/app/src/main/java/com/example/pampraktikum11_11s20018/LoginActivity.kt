...
import com.example.pampraktikum11_11s20018.databinding.ActivityLoginBinding
...
class LoginActivity: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        loginBinding.btnSignin.setOnClickListener {
            ...
            siginWithFirebase(email, password)
        }
    ...
    fun siginWithFirebase(email: String, password: String) {
