...
import com.example.pampraktikum11_11s20018.databinding.ActivityPhoneBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mCallbacks = object : PhoneAuthProvider.OnVerificationStateChangedCallbacks(){
            override fun onVerificationCompleted(p0: PhoneAuthCredential) {
                Toast.makeText(applicationContext, "Successfully sent verification code.", Toast.LENGTH_SHORT).show()
            }

            override fun onVerificationFailed(p0: FirebaseException) {
                Toast.makeText(applicationContext, "Failed to send verification code.", Toast.LENGTH_SHORT).show()
            }
    ...
    fun signingWithPhoneAuthCredential(credential: PhoneAuthCredential){
        auth.signInWithCredential(credential).addOnCompleteListener{task ->
            if(task.isSuccessful){
                ...
                Toast.makeText(applicationContext, "The code you entered incorrect", Toast.LENGTH_SHORT).show()
            }
