...
//import com.example.pampraktikum9_11s20018.databinding.ActivityMainBinding
//
...
//
//            builder.setSmallIcon(R.drawable.small_icon).setContentTitle("Belajar Notifikasi Android").setContentText("Kamu telah menekan tombol sebanyak ${counter}").setContentIntent(pendingIntent).setAutoCancel(true)
//                .addAction(R.drawable.small_icon, "Show Toast", actionPending)
//                .addAction(R.drawable.small_icon, "Dismiss", dismissPending)
//                .setLargeIcon(icon).setStyle(NotificationCompat.BigPictureStyle().bigPicture(icon).bigLargeIcon(null))
//        }else{
//            builder.setSmallIcon (R.drawable.small_icon).setContentTitle("Belajar Notifikasi Android").setContentText("Kamu telah menekan tombol sebanyak ${counter}").setPriority (NotificationCompat.PRIORITY_DEFAULT) .setContentIntent(pendingIntent).setAutoCancel(true)
//                .addAction(R.drawable.small_icon, "Show Toast", actionPending)
//                .addAction(R.drawable.small_icon, "Dismiss", dismissPending)
//                .setLargeIcon(icon).setStyle(NotificationCompat.BigPictureStyle().bigPicture(icon).bigLargeIcon(null))
//        }
