...
//
//        alertDialog.setTitle("Ubdah Tulisan Tombol").setMessage("Apakah kamu ingin mengubah tulisan pada tombol?").setIcon(R.drawable.warning).setCancelable(false).setNegativeButton("Batal",DialogInterface.OnClickListener{ dialog, which -> dialog.cancel()}).setPositiveButton("Ya", DialogInterface.OnClickListener{dialog, which -> btnShowDialog.text = "Kamu Mengubah tulisan"})
//
